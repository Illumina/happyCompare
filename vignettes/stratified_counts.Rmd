...
We will use a set of [publicly available](https://basespace.illumina.com/datacentral) NovaSeq builds 
...
If we furhter inspect the contents of `happy_results`, we can see that each of its elements matches the data structure described in `happyR`, e.g.:
